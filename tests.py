...
def main():
    ...
    #     print(f'{piece:=^30}\n')
    #     if e == 'pawn':
    #         test_simple_moves(defs[e], points, True)
    #     else:
    #         test_simple_moves(defs[e], points)
    ...
    #     print(f'{piece:=^30}\n')
    #     # if e == 'pawn':
    #     #     test_compound_moves(defs[e], points, True)
        
    #     test_compound_moves(defs[e], points)

    test_initial_game(defs)
